...
var $author$project$Model$initModel = {
	...
	fileList: _List_fromArray(
		['New File', 'SVG-1', 'SVG-2', 'SVG-3', 'SVG-4', 'SVG-5'])
};
...
var $author$project$Language$Syntax$ETuple2 = F3(
	function (a, b, c) {
		return {$: 'ETuple2', a: a, b: b, c: c};
	});
var $author$project$Language$Syntax$ETuple3 = F4(
	function (a, b, c, d) {
		return {$: 'ETuple3', a: a, b: b, c: c, d: d};
	});
...
var $author$project$Language$Syntax$DTuple2 = F2(
	function (a, b) {
		return {$: 'DTuple2', a: a, b: b};
	});
var $author$project$Language$Syntax$DTuple3 = F3(
	function (a, b, c) {
		return {$: 'DTuple3', a: a, b: b, c: c};
	});
			...
			switch (_v0.a.$) {
				...
				case 'PTuple3':
					if (_v0.b.$ === 'ATuple3') {
						...
						var a2 = _v17.b;
						var a3 = _v17.c;
						var _v18 = _Utils_Tuple3(
							A2($author$project$Language$UtilsFD$dmatch, p1, a1),
							A2($author$project$Language$UtilsFD$dmatch, p2, a2),
							A2($author$project$Language$UtilsFD$dmatch, p3, a3));
						if (((_v18.a.$ === 'Just') && (_v18.b.$ === 'Just')) && (_v18.c.$ === 'Just')) {
							var ctx1 = _v18.a.a;
							var ctx2 = _v18.b.a;
							var ctx3 = _v18.c.a;
							return $elm$core$Maybe$Just(
...
var $author$project$Language$UtilsFD$matchDBranch = F3(
	function (prm, b, cnt) {
		matchDBranch:
		while (true) {
			if (b.$ === 'DBSin') {
				var p = b.a;
				var d = b.b;
				var _v1 = A2($author$project$Language$UtilsFD$dmatch, p, prm);
				if (_v1.$ === 'Nothing') {
					return {choice: cnt + 1, ctx: _List_Nil, di: $elm$core$Maybe$Nothing, pi: p};
				} else {
					var ctx = _v1.a;
					return {
						choice: cnt + 1,
						ctx: ctx,
						di: $elm$core$Maybe$Just(d),
						pi: p
					};
				}
			} else {
				var b1 = b.a;
				var b2 = b.b;
				var res = A3($author$project$Language$UtilsFD$matchDBranch, prm, b1, cnt);
				var _v2 = res.di;
				if (_v2.$ === 'Nothing') {
					var $temp$prm = prm,
						$temp$b = b2,
...
var $author$project$Language$Syntax$ATuple2 = F2(
	function (a, b) {
		return {$: 'ATuple2', a: a, b: b};
	});
var $author$project$Language$Syntax$ATuple3 = F3(
	function (a, b, c) {
		return {$: 'ATuple3', a: a, b: b, c: c};
	});
		...
		while (true) {
			switch (param.$) {
				...
				case 'ATuple2':
					...
					var p2 = param.b;
					return A2(
						$author$project$Language$Syntax$ATuple2,
						A2($author$project$Language$DEval$peval, ctx, p1),
						A2($author$project$Language$DEval$peval, ctx, p2));
				case 'ATuple3':
					var p1 = param.a;
					...
					var p3 = param.c;
					return A3(
						$author$project$Language$Syntax$ATuple3,
						A2($author$project$Language$DEval$peval, ctx, p1),
						A2($author$project$Language$DEval$peval, ctx, p2),
						A2($author$project$Language$DEval$peval, ctx, p3));
				case 'AGraphic':
					var s = param.a;
					var p = param.b;
					return A2(
			...
			while (true) {
				switch (delta.$) {
					...
					case 'DTuple2':
						...
						var d2 = delta.b;
						return A2(
							$author$project$Language$Syntax$DTuple2,
							A2($author$project$Language$DEval$deval, ctx, d1),
							A2($author$project$Language$DEval$deval, ctx, d2));
					case 'DTuple3':
						var d1 = delta.a;
						...
						var d3 = delta.c;
						return A3(
							$author$project$Language$Syntax$DTuple3,
							A2($author$project$Language$DEval$deval, ctx, d1),
							A2($author$project$Language$DEval$deval, ctx, d2),
							A2($author$project$Language$DEval$deval, ctx, d3));
					case 'DCase':
						var p = delta.a;
						var bs = delta.b;
						var _v1 = A3(
							$author$project$Language$UtilsFD$matchDBranch,
							A2($author$project$Language$DEval$peval, ctx, p),
							bs,
							0).di;
						if (_v1.$ === 'Just') {
							...
							return $author$project$Language$Syntax$DError('Error 18');
						}
					case 'DApp':
						if (delta.a.$ === 'DFun') {
							var _v2 = delta.a;
...
var $author$project$Language$Syntax$VTuple2 = F2(
	function (a, b) {
		return {$: 'VTuple2', a: a, b: b};
	});
var $author$project$Language$Syntax$VTuple3 = F3(
	function (a, b, c) {
	...
	switch (v.$) {
		...
		case 'VTuple3':
			...
			return A3(
				...
				$author$project$Language$Utils$value2DId(v1),
				$author$project$Language$Utils$value2DId(v2),
				$author$project$Language$Utils$value2DId(v3));
		default:
			...
			switch (_v0.a.$) {
				...
				case 'PTuple3':
					if (_v0.b.$ === 'VTuple3') {
						...
						var v2 = _v16.b;
						var v3 = _v16.c;
						var _v17 = _Utils_Tuple3(
							A2($author$project$Language$Utils$match, p1, v1),
							A2($author$project$Language$Utils$match, p2, v2),
							A2($author$project$Language$Utils$match, p3, v3));
						if (((_v17.a.$ === 'Just') && (_v17.b.$ === 'Just')) && (_v17.c.$ === 'Just')) {
							var m1 = _v17.a.a;
							var m2 = _v17.b.a;
							var m3 = _v17.c.a;
							return $elm$core$Maybe$Just(
		...
		while (true) {
			switch (exp.$) {
				...
				case 'ETuple2':
					...
					var e2 = exp.c;
					return A2(
						$author$project$Language$Syntax$VTuple2,
						A2($author$project$Language$FEval$feval, env, e1),
						A2($author$project$Language$FEval$feval, env, e2));
				case 'ETuple3':
					var e1 = exp.b;
					...
					var e3 = exp.d;
					return A3(
						$author$project$Language$Syntax$VTuple3,
						A2($author$project$Language$FEval$feval, env, e1),
						A2($author$project$Language$FEval$feval, env, e2),
						A2($author$project$Language$FEval$feval, env, e3));
				case 'EParens':
					var e = exp.b;
					var $temp$env = env,
						$temp$exp = e;
	...
	switch (pattern.$) {
		...
		case 'PTuple3':
			...
			return _Utils_ap(
				...
				_Utils_ap(
					$author$project$Language$Utils$varsInPattern(p2),
					$author$project$Language$Utils$varsInPattern(p3)));
		default:
			return _List_Nil;
	}
};
		...
		switch (exp.$) {
			...
			case 'ETuple3':
				...
				return _Utils_ap(
					...
					_Utils_ap(
						$author$project$Language$Utils$freeVars(e2),
						$author$project$Language$Utils$freeVars(e3)));
			case 'EUPrim':
				var e = exp.c;
				var $temp$exp = e;
				exp = $temp$exp;
...
var $author$project$Language$Syntax$PTuple2 = F3(
	function (a, b, c) {
		return {$: 'PTuple2', a: a, b: b, c: c};
	});
var $author$project$Language$Syntax$PTuple3 = F4(
	function (a, b, c, d) {
		return {$: 'PTuple3', a: a, b: b, c: c, d: d};
	});
...
var $author$project$Language$UtilsFD$param2Exp = function (param) {
	switch (param.$) {
		...
		case 'ATuple2':
			...
			var a2 = param.b;
			return A3(
				$author$project$Language$Syntax$ETuple2,
				_List_fromArray(
					[' ', ' ', ' ']),
				$author$project$Language$UtilsFD$param2Exp(a1),
				$author$project$Language$UtilsFD$param2Exp(a2));
		case 'ATuple3':
			...
			var a3 = param.c;
			return A4(
				$author$project$Language$Syntax$ETuple3,
				_List_fromArray(
					[' ', ' ', ' ', ' ']),
				$author$project$Language$UtilsFD$param2Exp(a1),
				$author$project$Language$UtilsFD$param2Exp(a2),
				$author$project$Language$UtilsFD$param2Exp(a3));
		case 'AGraphic':
			var s = param.a;
			var a = param.b;
			return A3(
...
var $author$project$Language$Inject$pars = function (e) {
	return A2(
		$author$project$Language$Syntax$EParens,
		_List_fromArray(
			['', ' ']),
...
var $author$project$Language$Inject$inject = F2(
	function (delta, exp) {
		_v1$9:
		while (true) {
			switch (delta.$) {
				...
				case 'DAdd':
					var p = delta.a;
					return $author$project$Language$Inject$pars(
						A4(
							$author$project$Language$Syntax$EBPrim,
							_List_fromArray(
								[' ']),
							$author$project$Language$Syntax$Add,
							$author$project$Language$Inject$pars(exp),
					...
					switch (exp.$) {
						case 'ECons':
							...
							return A3(
								$author$project$Language$Syntax$ECons,
								ws,
								A2($author$project$Language$Inject$inject, d1, e1),
								A2($author$project$Language$Inject$inject, d2, e2));
						case 'EList':
							var ws = exp.a;
							var e1 = exp.b;
							var e2 = exp.c;
						...
						default:
							var fun = A3(
								...
								A3(
									...
									_List_fromArray(
										[' ']),
									A2(
										$author$project$Language$Inject$inject,
										d1,
										A2(
											$author$project$Language$Syntax$EVar,
											_List_fromArray(
							...
							return A3(
								$author$project$Language$Syntax$EApp,
								_List_Nil,
								$author$project$Language$Inject$pars(fun),
								$author$project$Language$Inject$pars(exp));
					}
				case 'DTuple2':
					var d1 = delta.a;
					...
					if (exp.$ === 'ETuple2') {
						...
						var fun = A3(
							...
							_List_fromArray(
								['', ' ']),
							A3(
								$author$project$Language$Syntax$PTuple2,
								_List_fromArray(
									[' ', ' ', ' ']),
								A2(
									$author$project$Language$Syntax$PVar,
				...
				case 'DTuple3':
					...
					if (exp.$ === 'ETuple3') {
						...
						return A4(
							...
							A2($author$project$Language$Inject$inject, d1, e1),
							A2($author$project$Language$Inject$inject, d2, e2),
							A2($author$project$Language$Inject$inject, d3, e3));
					} else {
						var fun = A3(
							$author$project$Language$Syntax$ELam,
							_List_fromArray(
								['', '']),
							A4(
								$author$project$Language$Syntax$PTuple3,
								_List_fromArray(
									['', '', '', '']),
								A2(
									$author$project$Language$Syntax$PVar,
				...
				case 'DCase':
					...
					var fun = A3(
						...
						A3(
							...
							$author$project$Language$UtilsFD$param2Exp(p),
							A2(
								$author$project$Language$Inject$injectBranch,
								bs,
								A2(
									$author$project$Language$Syntax$EVar,
									_List_fromArray(
				...
				case 'DApp':
					if (delta.a.$ === 'DFun') {
						...
						return A3(
							$author$project$Language$Syntax$EApp,
							_List_Nil,
							$author$project$Language$Inject$pars(
								A3(
									$author$project$Language$Syntax$ELam,
									_List_fromArray(
										['', ' ']),
									p,
									A2($author$project$Language$Inject$inject, d, exp))),
								...
								A3(
									...
									A2(
										...
										_List_fromArray(
											[' ']),
										'rec'),
									$author$project$Language$Inject$pars(e)),
								$author$project$Language$UtilsFD$param2Exp(prm)),
							$author$project$Language$Inject$pars(exp));
						var e2 = A3(
							$author$project$Language$Syntax$EApp,
		...
		return $author$project$Language$Syntax$EError('Injection Failed');
	});
var $author$project$Language$Inject$injectBranch = F2(
	function (bs, e) {
		if (bs.$ === 'DBSin') {
			var p = bs.a;
			var d = bs.b;
			return A3(
				...
				_List_fromArray(
					[' ']),
				p,
				A2($author$project$Language$Inject$inject, d, e));
		} else {
			var b1 = bs.a;
			var b2 = bs.b;
			return A3(
				...
				_List_fromArray(
					['\n']),
				A2($author$project$Language$Inject$injectBranch, b1, e),
				A2($author$project$Language$Inject$injectBranch, b2, e));
		}
	});
		...
		switch (p.$) {
			...
			case 'PTuple3':
				...
				return A3(
					...
					A2($author$project$Language$Utils$substDelta, p1, env),
					A2($author$project$Language$Utils$substDelta, p2, env),
					A2($author$project$Language$Utils$substDelta, p3, env));
			default:
				return $author$project$Language$Syntax$DId;
		}
	});
...
var $author$project$Language$UtilsFD$eqDBranch = F2(
	function (b1, b2) {
		var _v17 = _Utils_Tuple2(b1, b2);
		_v17$2:
		while (true) {
			if (_v17.a.$ === 'DBSin') {
				if (_v17.b.$ === 'DBSin') {
				...
				if (_v17.b.$ === 'DBCom') {
					...
					var b21 = _v21.a;
					var b22 = _v21.b;
					return A2($author$project$Language$UtilsFD$eqDBranch, b11, b21) && A2($author$project$Language$UtilsFD$eqDBranch, b12, b22);
				} else {
					break _v17$2;
				}
			}
								...
								switch (_v0.a.$) {
									...
									case 'DTuple3':
										if (_v0.b.$ === 'DTuple3') {
											...
											var d22 = _v6.b;
											var d23 = _v6.c;
											return A2($author$project$Language$UtilsFD$eqDelta, d11, d21) && (A2($author$project$Language$UtilsFD$eqDelta, d12, d22) && A2($author$project$Language$UtilsFD$eqDelta, d13, d23));
										} else {
											break _v0$8;
										}
									case 'DApp':
									...
									case 'DCase':
										if (_v0.b.$ === 'DCase') {
											...
											var p2 = _v14.a;
											var bs2 = _v14.b;
											return A2($author$project$Language$UtilsFD$eqDBranch, bs1, bs2) && _Utils_eq(p1, p2);
										} else {
											break _v0$8;
										}
									case 'DGen':
		...
		while (true) {
			if (_v0.a.b) {
				if (_v0.b.b) {
					...
					var d2 = _v6.b;
					var env2_ = _v4.b;
					return _Utils_eq(s1, s2) ? ((A2($author$project$Language$UtilsFD$eqDelta, d1, d2) || (!A2($elm$core$List$member, s1, fv2))) ? A2(
						...
						function (d) {
							return A2(
								...
								A4($author$project$Language$Utils$two_wayMerge, fv1, fv2, env1_, env2_));
						},
						A2($author$project$Language$UtilsFD$fixCheck, v1, d1)) : ((!A2($elm$core$List$member, s1, fv1)) ? A2(
						$elm$core$Maybe$andThen,
						function (d) {
							return A2(
								$elm$core$Maybe$map,
						...
						A2($author$project$Language$UtilsFD$fixCheck, v1, d2)) : $elm$core$Maybe$Nothing)) : $elm$core$Maybe$Nothing;
				} else {
					break _v0$2;
				}
			} else {
	...
	switch (value.$) {
		...
		case 'VTuple3':
			...
			return A3(
				...
				$author$project$Language$UtilsFD$value2Param(v1),
				$author$project$Language$UtilsFD$value2Param(v2),
				$author$project$Language$UtilsFD$value2Param(v3));
		case 'VError':
			var info = value.a;
		...
		while (true) {
			...
			while (true) {
				...
				while (true) {
					...
					while (true) {
						...
						while (true) {
							...
							while (true) {
								...
								while (true) {
											...
											case 'DNot':
												switch (_v0.a.$) {
													case 'ETrue':
														...
														return _Utils_Tuple3(
															env,
															$author$project$Language$Syntax$EFalse(ws),
															st);
													case 'EFalse':
														var ws = _v0.a.a;
														var _v7 = _v0.b;
														return _Utils_Tuple3(
															env,
															$author$project$Language$Syntax$ETrue(ws),
															st);
													case 'EVar':
														break _v0$13;
													case 'EApp':
											...
											case 'DCons':
												switch (_v0.a.$) {
													...
													case 'ECons':
														...
														var d1 = _v39.a;
														var d2 = _v39.b;
														var _v40 = A4($author$project$Language$BEval$beval, env, e2, d2, st);
														var env2 = _v40.a;
														var new_e2 = _v40.b;
														var st2 = _v40.c;
														var _v41 = A4($author$project$Language$BEval$beval, env, e1, d1, st);
														var env1 = _v41.a;
														var new_e1 = _v41.b;
														var st1 = _v41.c;
														...
														if (_Utils_eq(
															new_e1,
															$author$project$Language$Syntax$EError('Injection Failed')) || _Utils_eq(
															new_e2,
															$author$project$Language$Syntax$EError('Injection Failed'))) {
															return _Utils_Tuple3(
																env,
																A2($author$project$Language$Inject$inject, delta, exp),
																new_ST);
														} else {
															var _v42 = A4(
													...
													case 'EList':
														...
														var d1 = _v72.a;
														var d2 = _v72.b;
														var _v73 = A4($author$project$Language$BEval$beval, env, e2, d2, st);
														var env2 = _v73.a;
														var new_e2 = _v73.b;
														var st2 = _v73.c;
														var _v74 = A4($author$project$Language$BEval$beval, env, e1, d1, st);
														var env1 = _v74.a;
														var new_e1 = _v74.b;
														var st1 = _v74.c;
														var new_ST = A2($author$project$Language$UtilsFD$mergeST, st1, st2);
											...
											case 'DModify':
												switch (_v0.a.$) {
													...
													case 'ECons':
														...
														var d = _v54.b;
														if (!n) {
															var _v55 = A4($author$project$Language$BEval$beval, env, e1, d, st);
															var env1 = _v55.a;
															var new_e1 = _v55.b;
															var st_ = _v55.c;
															return _Utils_Tuple3(
													...
													case 'EList':
														...
														var d = _v90.b;
														if (!n) {
															var _v91 = A4($author$project$Language$BEval$beval, env, e1, d, st);
															var env1 = _v91.a;
															var new_e1 = _v91.b;
															var st_ = _v91.c;
															return _Utils_Tuple3(
														...
														if (_v60.$ === 'VTuple2') {
															...
															var d1 = A2(
																...
																A2(
																	...
																	df,
																	$author$project$Language$UtilsFD$value2Param(v1)));
															var _v61 = A4($author$project$Language$BEval$beval, env, e2, d2, st);
															var env2 = _v61.a;
															var new_e2 = _v61.b;
															var st2 = _v61.c;
															var _v62 = A4($author$project$Language$BEval$beval, env, e1, d1, st);
															var env1 = _v62.a;
															var new_e1 = _v62.b;
															var st1 = _v62.c;
															var new_ST = A2($author$project$Language$UtilsFD$mergeST, st1, st2);
														...
														if (_v96.$ === 'VTuple2') {
															...
															var d1 = A2(
																...
																A2(
																	...
																	df,
																	$author$project$Language$UtilsFD$value2Param(v1)));
															var _v97 = A4($author$project$Language$BEval$beval, env, e2, d2, st);
															var env2 = _v97.a;
															var new_e2 = _v97.b;
															var st2 = _v97.c;
															var _v98 = A4($author$project$Language$BEval$beval, env, e1, d1, st);
															var env1 = _v98.a;
															var new_e1 = _v98.b;
															var st1 = _v98.c;
															var new_ST = A2($author$project$Language$UtilsFD$mergeST, st1, st2);
												...
												switch (_v0.a.$) {
													...
													case 'ECons':
														if (_v0.b.b.$ === 'ACons') {
															...
															switch (a1.$) {
																case 'ATrue':
																	var _v69 = A2($author$project$Utils$lookup, s, st_);
																	if (_v69.$ === 'Just') {
																		var _v70 = _v69.a;
																		var ls = _v70.b;
																		return _Utils_Tuple3(
													...
													case 'EList':
														if (_v0.b.b.$ === 'ACons') {
															...
															switch (a1.$) {
																case 'ATrue':
																	var _v105 = A2($author$project$Utils$lookup, s, st_);
																	if (_v105.$ === 'Just') {
																		var _v106 = _v105.a;
																		var ls = _v106.b;
																		return _Utils_Tuple3(
											...
											case 'DTuple2':
												switch (_v0.a.$) {
													...
													case 'ETuple2':
														...
														var d1 = _v108.a;
														var d2 = _v108.b;
														var _v109 = A4($author$project$Language$BEval$beval, env, e2, d2, st);
														var env2 = _v109.a;
														var new_e2 = _v109.b;
														var st2 = _v109.c;
														var _v110 = A4($author$project$Language$BEval$beval, env, e1, d1, st);
														var env1 = _v110.a;
														var new_e1 = _v110.b;
														var st1 = _v110.c;
														var new_ST = A2($author$project$Language$UtilsFD$mergeST, st1, st2);
														if (_Utils_eq(
															...
															if (_v111.$ === 'Just') {
																...
																return _Utils_Tuple3(
																	new_env,
																	A3($author$project$Language$Syntax$ETuple2, ws, new_e1, new_e2),
																	new_ST);
															} else {
																return _Utils_Tuple3(
																	env,
											...
											case 'DTuple3':
												switch (_v0.a.$) {
													...
													case 'ETuple3':
														...
														var d2 = _v113.b;
														var d3 = _v113.c;
														var _v114 = A4($author$project$Language$BEval$beval, env, e3, d3, st);
														var env3 = _v114.a;
														var new_e3 = _v114.b;
														var st3 = _v114.c;
														var _v115 = A4($author$project$Language$BEval$beval, env, e2, d2, st);
														var env2 = _v115.a;
														var new_e2 = _v115.b;
														var st2 = _v115.c;
														var _v116 = A4($author$project$Language$BEval$beval, env, e1, d1, st);
														var env1 = _v116.a;
														var new_e1 = _v116.b;
														var st1 = _v116.c;
														var new_ST = A2(
															$author$project$Language$UtilsFD$mergeST,
															st1,
															A2($author$project$Language$UtilsFD$mergeST, st2, st3));
														...
														if (_Utils_eq(
															...
															var _v118 = A4($author$project$Language$Utils$two_wayMerge, fv1, fv2, env1, env2);
															if (_v118.$ === 'Just') {
																var new_env = _v118.a;
																var _v119 = A4(
																	$author$project$Language$Utils$two_wayMerge,
																	...
																	env3);
																if (_v119.$ === 'Just') {
																	var new_env2 = _v119.a;
																	return _Utils_Tuple3(
																		new_env2,
																		A4($author$project$Language$Syntax$ETuple3, ws, new_e1, new_e2, new_e3),
																		new_ST);
																} else {
																	return _Utils_Tuple3(
																		env,
													...
													case 'EBPrim':
														switch (_v0.a.b.$) {
															case 'Add':
																...
																var e1 = _v122.c;
																var e2 = _v122.d;
																var _v124 = A4($author$project$Language$BEval$beval, env, e1, delta, _List_Nil);
																var env1 = _v124.a;
																var new_e1 = _v124.b;
																var _v125 = _Utils_Tuple2(
																	$author$project$Language$Utils$freeVars(e1),
																	$author$project$Language$Utils$freeVars(e2));
																var fv1 = _v125.a;
																var fv2 = _v125.b;
																var _v126 = A4($author$project$Language$Utils$two_wayMerge, fv1, fv2, env1, env);
																if (_v126.$ === 'Just') {
																	var new_env = _v126.a;
																	return _Utils_Tuple3(
																		new_env,
															...
															case 'Mul':
																if (_v0.b.a.$ === 'AFloat') {
																	...
																	var e2 = _v127.d;
																	var f = _v0.b.a.a;
																	var _v129 = A2($author$project$Language$FEval$feval, env, e2);
																	if (_v129.$ === 'VFloat') {
																		var f2 = _v129.a;
																		var _v130 = A4(
																			$author$project$Language$BEval$beval,
																		...
																		var env1 = _v130.a;
																		var new_e1 = _v130.b;
																		var _v131 = _Utils_Tuple2(
																			$author$project$Language$Utils$freeVars(e1),
																			$author$project$Language$Utils$freeVars(e2));
																		var fv1 = _v131.a;
																		var fv2 = _v131.b;
																		var _v132 = A4($author$project$Language$Utils$two_wayMerge, fv1, fv2, env1, env);
																		if (_v132.$ === 'Just') {
																			var new_env = _v132.a;
																			return _Utils_Tuple3(
																				new_env,
												...
												switch (_v0.a.$) {
														...
														switch (_v0.a.b.$) {
															case 'Add':
																if (_v0.b.a.$ === 'AFloat') {
																	...
																	var e2 = _v133.d;
																	var f = _v0.b.a.a;
																	var _v135 = _Utils_Tuple3(
																		A2($author$project$Language$FEval$feval, env, exp),
																		A2($author$project$Language$FEval$feval, env, e1),
																		A2($author$project$Language$FEval$feval, env, e2));
																	if (((_v135.a.$ === 'VFloat') && (_v135.b.$ === 'VFloat')) && (_v135.c.$ === 'VFloat')) {
																		var sum = _v135.a.a;
																		var f1 = _v135.b.a;
																		var f2 = _v135.c.a;
																		var delta1 = $author$project$Language$Syntax$DMul(
																			$author$project$Language$Syntax$AFloat(((f * sum) - f2) / f1));
																		var _v136 = A4($author$project$Language$BEval$beval, env, e1, delta1, _List_Nil);
																		var env1 = _v136.a;
																		var new_e1 = _v136.b;
																		var _v137 = _Utils_Tuple2(
																			$author$project$Language$Utils$freeVars(e1),
																			$author$project$Language$Utils$freeVars(e2));
																		var fv1 = _v137.a;
																		var fv2 = _v137.b;
																		var _v138 = A4($author$project$Language$Utils$two_wayMerge, fv1, fv2, env1, env);
																		if (_v138.$ === 'Just') {
																			var new_env = _v138.a;
																			return _Utils_Tuple3(
																				new_env,
															...
															case 'Mul':
																...
																var e1 = _v139.c;
																var e2 = _v139.d;
																var _v141 = A4($author$project$Language$BEval$beval, env, e1, delta, _List_Nil);
																var env1 = _v141.a;
																var new_e1 = _v141.b;
																var _v142 = _Utils_Tuple2(
																	$author$project$Language$Utils$freeVars(e1),
																	$author$project$Language$Utils$freeVars(e2));
																var fv1 = _v142.a;
																var fv2 = _v142.b;
																var _v143 = A4($author$project$Language$Utils$two_wayMerge, fv1, fv2, env1, env);
																if (_v143.$ === 'Just') {
																	var new_env = _v143.a;
																	return _Utils_Tuple3(
																		new_env,
													...
													case 'EUPrim':
														if (_v0.a.b.$ === 'Neg') {
															...
															var _v148 = _v147.b;
															var e1 = _v147.c;
															var _v149 = A4($author$project$Language$BEval$beval, env, e1, delta, _List_Nil);
															var env1 = _v149.a;
															var new_e1 = _v149.b;
															return _Utils_Tuple3(
																env1,
															...
															if (st1.b) {
																...
																return _Utils_Tuple3(
																	...
																	A3(
																		...
																		_List_Nil,
																		$author$project$Language$Inject$pars(fun),
																		$author$project$Language$Inject$pars(sub)),
																	st_);
															} else {
																return _Utils_Tuple3(
																	_List_Nil,
											...
											case 'DCom':
												switch (_v0.a.$) {
													...
													default:
														...
														var d1 = _v163.a;
														var d2 = _v163.b;
														var _v164 = A4($author$project$Language$BEval$beval, env, e, d1, st);
														var env1 = _v164.a;
														var e1 = _v164.b;
														var st1 = _v164.c;
														var _v165 = A4($author$project$Language$BEval$beval, env1, e1, d2, st);
														var env2 = _v165.a;
														var e2 = _v165.b;
														var st2 = _v165.c;
														return _Utils_Tuple3(
									...
									var $temp$env = env,
										$temp$exp = exp,
										$temp$delta = A2($author$project$Language$DEval$deval, _List_Nil, d),
										$temp$st = st;
									env = $temp$env;
									exp = $temp$exp;
									delta = $temp$delta;
								...
								var e = _v150.c;
								var d = _v0.b;
								var _v151 = A4($author$project$Language$BEval$beval, env, e, d, st);
								var env1 = _v151.a;
								var new_e = _v151.b;
								var st_ = _v151.c;
								return _Utils_Tuple3(
							...
							var ws = _v120.a;
							var e1 = _v120.b;
							var _v121 = A4($author$project$Language$BEval$beval, env, e1, delta, st);
							var env1 = _v121.a;
							var new_e1 = _v121.b;
							var st_ = _v121.c;
							return _Utils_eq(
								new_e1,
								$author$project$Language$Syntax$EError('Injection Failed')) ? _Utils_Tuple3(
								env,
								$author$project$Language$Syntax$EError('Injection Failed'),
								st_) : _Utils_Tuple3(
								env1,
						...
						if (_v32.$ === 'EError') {
							...
							if (_Utils_eq(
								...
								var _v37 = A4($author$project$Language$Utils$two_wayMerge, fv1, fv2, env1, env2);
								if (_v37.$ === 'Just') {
									var new_env = _v37.a;
									return _Utils_Tuple3(
										new_env,
					...
					var e1 = _v19.b;
					var e2 = _v19.c;
					var _v20 = A2($author$project$Language$FEval$feval, env, e1);
					if (_v20.$ === 'VClosure') {
						var envf = _v20.a;
						var p = _v20.b;
						var ef = _v20.c;
						...
						if (envm_res.$ === 'Just') {
							...
							if (_Utils_eq(
								...
								var _v27 = A4($author$project$Language$Utils$two_wayMerge, fv1, fv2, env1, env2);
								if (_v27.$ === 'Just') {
									var new_env = _v27.a;
									return _Utils_Tuple3(
										new_env,
				...
				var x = _v16.b;
				return _Utils_Tuple3(
					A3($author$project$Language$Utils$updateDelta, env, x, delta),
					exp,
					st);
			}
			var s = _v0.b.a.a;
			...
			if (_v2.$ === 'Just') {
				var _v3 = _v2.a;
				var env1 = _v3.a;
				return _Utils_eq(env1, env) ? _Utils_Tuple3(
					env,
					A2(
						$author$project$Language$Syntax$EVar,
						_List_fromArray(
							[' ']),
						s),
					A3($author$project$Language$UtilsFD$updateST, st, s, exp)) : _Utils_Tuple3(env, exp, st);
			} else {
				return _Utils_Tuple3(
					_List_Nil,
...
var $author$project$Language$Syntax$DBSin = F2(
	function (a, b) {
		return {$: 'DBSin', a: a, b: b};
	});
var $author$project$Language$Syntax$DCase = F2(
	function (a, b) {
		return {$: 'DCase', a: a, b: b};
	});
...
var $author$project$Parser$Utils$varName = $elm$parser$Parser$variable(
	{
		...
		reserved: $elm$core$Set$fromList(
			_List_fromArray(
				['rect', 'circle', 'ellipse', 'line', 'polygon', 'if', 'id', 'in', 'of', 'not', 'let', 'nil', 'then', 'else', 'true', 'rewr', 'case', 'false', 'letrec', 'insert', 'delete', 'modify', 'copy', 'group', 'mem'])),
		start: $elm$core$Char$isAlpha
	});
var $author$project$Parser$Delta$pvar = A2(
	$elm$parser$Parser$keeper,
	...
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				$author$project$Parser$Delta$pfloat,
				$author$project$Parser$Delta$pvar,
				$elm$parser$Parser$backtrackable(
				$author$project$Parser$Delta$cyclic$pparens()),
				$elm$parser$Parser$backtrackable(
				$author$project$Parser$Delta$cyclic$ptuple2()),
				$author$project$Parser$Delta$cyclic$ptuple3(),
...
function $author$project$Parser$Delta$cyclic$ptuple2() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			A2(
				...
				A2(
					$elm$parser$Parser$ignorer,
					$elm$parser$Parser$succeed($author$project$Language$Syntax$ATuple2),
					$elm$parser$Parser$symbol('(')),
				$elm$parser$Parser$spaces),
			A2(
				$elm$parser$Parser$ignorer,
...
function $author$project$Parser$Delta$cyclic$ptuple3() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			A2(
				...
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$succeed($author$project$Language$Syntax$ATuple3),
						$elm$parser$Parser$symbol('(')),
					$elm$parser$Parser$spaces),
				A2(
					$elm$parser$Parser$ignorer,
...
try {
	...
	var $author$project$Parser$Delta$ptuple2 = $author$project$Parser$Delta$cyclic$ptuple2();
	$author$project$Parser$Delta$cyclic$ptuple2 = function () {
		return $author$project$Parser$Delta$ptuple2;
	};
	var $author$project$Parser$Delta$ptuple3 = $author$project$Parser$Delta$cyclic$ptuple3();
	$author$project$Parser$Delta$cyclic$ptuple3 = function () {
		return $author$project$Parser$Delta$ptuple3;
	};
} catch ($) {
...
var $author$project$Language$Syntax$DBCom = F2(
	function (a, b) {
		return {$: 'DBCom', a: a, b: b};
	});
var $author$project$Parser$Delta$branchOp = _List_fromArray(
	[
		_List_fromArray(
		[
			A2(
			...
			A2(
				...
				A2(
					$elm$parser$Parser$ignorer,
					$elm$parser$Parser$succeed($author$project$Language$Syntax$DBCom),
					$elm$parser$Parser$symbol('|')),
				$elm$parser$Parser$spaces),
			$Punie$elm_parser_extras$Parser$Expression$AssocRight)
		])
...
var $author$project$Parser$Delta$dmul = A2(
	...
	A2(
		...
		$elm$parser$Parser$symbol('*')),
	A2($elm$parser$Parser$ignorer, $author$project$Parser$Delta$param, $elm$parser$Parser$spaces));
var $author$project$Language$Syntax$DNot = {$: 'DNot'};
var $author$project$Parser$Delta$dnot = A2(
	$elm$parser$Parser$ignorer,
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$succeed($author$project$Language$Syntax$DNot),
...
var $author$project$Parser$Exp$mfloat = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$keeper,
...
var $author$project$Parser$Pattern$ptrue = A2(
	...
	A2(
		...
		$elm$parser$Parser$keyword('true')),
	$author$project$Parser$WhiteSpace$mspaces);
var $author$project$Parser$Pattern$pvar = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed(
	...
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				$elm$parser$Parser$backtrackable(
				$author$project$Parser$Pattern$cyclic$ptuple2()),
				$author$project$Parser$Pattern$cyclic$ptuple3(),
...
function $author$project$Parser$Pattern$cyclic$ptuple2() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
...
function $author$project$Parser$Pattern$cyclic$ptuple3() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
...
try {
	...
	var $author$project$Parser$Pattern$ptuple2 = $author$project$Parser$Pattern$cyclic$ptuple2();
	$author$project$Parser$Pattern$cyclic$ptuple2 = function () {
		return $author$project$Parser$Pattern$ptuple2;
	};
	var $author$project$Parser$Pattern$ptuple3 = $author$project$Parser$Pattern$cyclic$ptuple3();
	$author$project$Parser$Pattern$cyclic$ptuple3 = function () {
		return $author$project$Parser$Pattern$ptuple3;
	};
} catch ($) {
...
var $author$project$Parser$Exp$true = A2(
	...
	A2(
		...
		$elm$parser$Parser$keyword('true')),
	$author$project$Parser$WhiteSpace$mspaces);
var $author$project$Parser$Exp$var = A2(
	$elm$parser$Parser$keeper,
	A2(
		$elm$parser$Parser$keeper,
		$elm$parser$Parser$succeed(
	...
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				$elm$parser$Parser$backtrackable(
				$author$project$Parser$Exp$cyclic$tuple2()),
				$author$project$Parser$Exp$cyclic$tuple3(),
				$author$project$Parser$Exp$true,
				$author$project$Parser$Exp$false,
				$author$project$Parser$Exp$mfloat,
...
function $author$project$Parser$Exp$cyclic$tuple2() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
...
function $author$project$Parser$Exp$cyclic$tuple3() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
						...
						A2(
							...
							A2(
								...
								A2(
									...
									$elm$parser$Parser$succeed(
										F7(
											function (spc1, e1, spc2, e2, spc3, e3, spc4) {
												return A4(
													$author$project$Language$Syntax$ETuple3,
													_List_fromArray(
														[spc1, spc2, spc3, spc4]),
...
try {
	...
	var $author$project$Parser$Exp$tuple2 = $author$project$Parser$Exp$cyclic$tuple2();
	$author$project$Parser$Exp$cyclic$tuple2 = function () {
		return $author$project$Parser$Exp$tuple2;
	};
	var $author$project$Parser$Exp$tuple3 = $author$project$Parser$Exp$cyclic$tuple3();
	$author$project$Parser$Exp$cyclic$tuple3 = function () {
		return $author$project$Parser$Exp$tuple3;
	};
} catch ($) {
	...
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				...
				$author$project$Parser$Delta$dnot,
				...
				$elm$parser$Parser$backtrackable(
				$author$project$Parser$Delta$cyclic$dtuple2()),
				$author$project$Parser$Delta$cyclic$dtuple3(),
				$author$project$Parser$Delta$cyclic$dfun(),
				$author$project$Parser$Delta$cyclic$dapp(),
				$author$project$Parser$Delta$cyclic$dgen(),
				$author$project$Parser$Delta$cyclic$caseOf(),
...
function $author$project$Parser$Delta$cyclic$caseOf() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			A2(
				...
				A2(
					$elm$parser$Parser$ignorer,
					$elm$parser$Parser$succeed($author$project$Language$Syntax$DCase),
					$elm$parser$Parser$keyword('case')),
				$elm$parser$Parser$spaces),
			A2(
				$elm$parser$Parser$ignorer,
				A2(
					...
					$elm$parser$Parser$keyword('of')),
				$elm$parser$Parser$spaces)),
		$author$project$Parser$Delta$cyclic$branch());
}
function $author$project$Parser$Delta$cyclic$branch() {
	return A2(
		$Punie$elm_parser_extras$Parser$Expression$buildExpressionParser,
		$author$project$Parser$Delta$branchOp,
		$author$project$Parser$Delta$cyclic$sinBranch());
}
...
function $author$project$Parser$Delta$cyclic$dtuple2() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			A2(
				...
				A2(
					$elm$parser$Parser$ignorer,
					$elm$parser$Parser$succeed($author$project$Language$Syntax$DTuple2),
					$elm$parser$Parser$symbol('(')),
				$elm$parser$Parser$spaces),
			A2(
				$elm$parser$Parser$ignorer,
...
function $author$project$Parser$Delta$cyclic$dtuple3() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			A2(
				...
				A2(
					...
					A2(
						$elm$parser$Parser$ignorer,
						$elm$parser$Parser$succeed($author$project$Language$Syntax$DTuple3),
						$elm$parser$Parser$symbol('(')),
					$elm$parser$Parser$spaces),
				A2(
					$elm$parser$Parser$ignorer,
...
function $author$project$Parser$Delta$cyclic$sinBranch() {
	return A2(
		$elm$parser$Parser$keeper,
		A2(
			$elm$parser$Parser$keeper,
			$elm$parser$Parser$succeed($author$project$Language$Syntax$DBSin),
			A2(
				$elm$parser$Parser$ignorer,
				A2(
					$elm$parser$Parser$ignorer,
...
try {
	...
	var $author$project$Parser$Delta$caseOf = $author$project$Parser$Delta$cyclic$caseOf();
	$author$project$Parser$Delta$cyclic$caseOf = function () {
		return $author$project$Parser$Delta$caseOf;
	};
	var $author$project$Parser$Delta$branch = $author$project$Parser$Delta$cyclic$branch();
	$author$project$Parser$Delta$cyclic$branch = function () {
		return $author$project$Parser$Delta$branch;
	};
	...
	var $author$project$Parser$Delta$dtuple2 = $author$project$Parser$Delta$cyclic$dtuple2();
	$author$project$Parser$Delta$cyclic$dtuple2 = function () {
		return $author$project$Parser$Delta$dtuple2;
	};
	var $author$project$Parser$Delta$dtuple3 = $author$project$Parser$Delta$cyclic$dtuple3();
	$author$project$Parser$Delta$cyclic$dtuple3 = function () {
		return $author$project$Parser$Delta$dtuple3;
	};
	...
	var $author$project$Parser$Delta$sinBranch = $author$project$Parser$Delta$cyclic$sinBranch();
	$author$project$Parser$Delta$cyclic$sinBranch = function () {
		return $author$project$Parser$Delta$sinBranch;
	};
} catch ($) {
	throw 'Some top-level definitions from `Parser.Delta` are causing infinite recursion:\n\n  ┌─────┐\n  │    temp\n  │     ↓\n  │    caseOf\n  │     ↓\n  │    branch\n  │     ↓\n  │    ctt\n  │     ↓\n  │    dapp\n  │     ↓\n  │    delta\n  │     ↓\n  │    dfun\n  │     ↓\n  │    dgen\n  │     ↓\n  │    dparens\n  │     ↓\n  │    dtuple2\n  │     ↓\n  │    dtuple3\n  │     ↓\n  │    group\n  │     ↓\n  │    list\n  │     ↓\n  │    listloop\n  │     ↓\n  │    listHelper\n  │     ↓\n  │    modify\n  │     ↓\n  │    sinBranch\n  └─────┘\n\nThese errors are very tricky, so read https://elm-lang.org/0.19.1/bad-recursion to learn how to fix it!';}
...
var $author$project$Parser$Exp$parse = $elm$parser$Parser$run(
	A2($elm$parser$Parser$ignorer, $author$project$Parser$Exp$exp, $elm$parser$Parser$end));
		...
		switch (p.$) {
			...
			case 'PTuple3':
				if ((((p.a.b && p.a.b.b) && p.a.b.b.b) && p.a.b.b.b.b) && (!p.a.b.b.b.b.b)) {
					...
					var t2 = p.c;
					var t3 = p.d;
					return '(' + (spc1 + ($author$project$Printer$Pattern$printPattern(t1) + (',' + (spc2 + ($author$project$Printer$Pattern$printPattern(t2) + (',' + (spc3 + ($author$project$Printer$Pattern$printPattern(t3) + (')' + spc4)))))))));
				} else {
					break _v0$13;
				}
			default:
...
var $author$project$Printer$Exp$print = function (exp) {
	...
	while (true) {
		switch (exp.$) {
					...
					if (exp.a.b.b) {
						if (!exp.a.b.b.b) {
							if (exp.b.$ === 'ELam') {
								...
								var e2 = _v16.c;
								var e1 = exp.c;
								var _v17 = A2($author$project$Printer$Exp$splitFuncDef, _List_Nil, e1);
								var paramList = _v17.a;
								var tFunc = _v17.b;
								return $author$project$Printer$Pattern$printPattern(p) + ($author$project$Printer$Exp$printParamList(paramList) + ('=' + (spc1 + ($author$project$Printer$Exp$print(tFunc) + (';' + (spc2 + $author$project$Printer$Exp$print(e2)))))));
							} else {
								break _v5$24;
							}
						} else {
							if (((exp.a.b.b.b.b && (!exp.a.b.b.b.b.b)) && (exp.b.$ === 'ELam')) && (!exp.b.a.b)) {
								switch (exp.a.a) {
									case 'LET':
										var _v18 = exp.a;
										var _v19 = _v18.b;
									...
									case 'LETREC':
										if ((((exp.c.$ === 'EFix') && (!exp.c.a.b)) && (exp.c.b.$ === 'ELam')) && (!exp.c.b.a.b)) {
											var _v23 = exp.a;
											var _v24 = _v23.b;
											var spc1 = _v24.a;
											var _v25 = _v24.b;
			...
			case 'ETuple3':
				if ((((exp.a.b && exp.a.b.b) && exp.a.b.b.b) && exp.a.b.b.b.b) && (!exp.a.b.b.b.b.b)) {
					var _v41 = exp.a;
					var spc1 = _v41.a;
					var _v42 = _v41.b;
					var spc2 = _v42.a;
					...
					var e2 = exp.c;
					var e3 = exp.d;
					return '(' + (spc1 + ($author$project$Printer$Exp$print(e1) + (',' + (spc2 + ($author$project$Printer$Exp$print(e2) + (',' + (spc3 + ($author$project$Printer$Exp$print(e3) + (')' + spc4)))))))));
				} else {
					break _v5$24;
				}
			case 'EBPrim':
...
var $author$project$Printer$Value$printParam = function (param) {
	switch (param.$) {
		...
		case 'ATuple3':
			...
			var p2 = param.b;
			var p3 = param.c;
			return '(' + ($author$project$Printer$Value$printParam(p1) + (', ' + ($author$project$Printer$Value$printParam(p2) + (', ' + ($author$project$Printer$Value$printParam(p3) + ')')))));
		case 'AGraphic':
			var s = param.a;
			var p = param.b;
...
var $author$project$Printer$Value$print = function (v) {
	...
	while (true) {
		switch (v.$) {
			...
			case 'VTuple3':
				...
				var v2 = v.b;
				var v3 = v.c;
				return '( ' + ($author$project$Printer$Value$print(v1) + (', ' + ($author$project$Printer$Value$print(v2) + (', ' + ($author$project$Printer$Value$print(v3) + ' )')))));
			case 'VError':
				var info = v.a;
				return info;
			default:
				if (v.b.$ === 'VCons') {
					switch (v.a) {
						case 'rect':
							if (((((v.b.b.$ === 'VCons') && (v.b.b.b.$ === 'VCons')) && (v.b.b.b.b.$ === 'VCons')) && (v.b.b.b.b.b.$ === 'VCons')) && (v.b.b.b.b.b.b.$ === 'VNil')) {
								var _v9 = v.b;
								var color = _v9.a;
								var _v10 = _v9.b;
								var x = _v10.a;
								...
								var h = _v13.a;
								var _v14 = _v13.b;
								return '<rect ' + ($author$project$Printer$Value$printFill(color) + (' x=\"' + ($author$project$Printer$Value$print(x) + ('\" y=\"' + ($author$project$Printer$Value$print(y) + ('\" width=\"' + ($author$project$Printer$Value$print(w) + ('\" height=\"' + ($author$project$Printer$Value$print(h) + '\"></rect>')))))))));
							} else {
								break _v8$18;
							}
						case 'square':
							if ((((v.b.b.$ === 'VCons') && (v.b.b.b.$ === 'VCons')) && (v.b.b.b.b.$ === 'VCons')) && (v.b.b.b.b.b.$ === 'VNil')) {
								var _v15 = v.b;
								var color = _v15.a;
								var _v16 = _v15.b;
								var x = _v16.a;
								...
								var w = _v18.a;
								var _v19 = _v18.b;
								return '<rect ' + ($author$project$Printer$Value$printFill(color) + (' x=\"' + ($author$project$Printer$Value$print(x) + ('\" y=\"' + ($author$project$Printer$Value$print(y) + ('\" width=\"' + ($author$project$Printer$Value$print(w) + ('\" height=\"' + ($author$project$Printer$Value$print(w) + '\"></rect>')))))))));
							} else {
								break _v8$18;
							}
						case 'circle':
							if ((((v.b.b.$ === 'VCons') && (v.b.b.b.$ === 'VCons')) && (v.b.b.b.b.$ === 'VCons')) && (v.b.b.b.b.b.$ === 'VNil')) {
								...
								var r = _v23.a;
								var _v24 = _v23.b;
								return '<circle ' + ($author$project$Printer$Value$printFill(color) + (' cx=\"' + ($author$project$Printer$Value$print(x) + ('\" cy=\"' + ($author$project$Printer$Value$print(y) + ('\" r=\"' + ($author$project$Printer$Value$print(r) + '\"></circle>')))))));
							} else {
								break _v8$18;
							}
						case 'ellipse':
							if (((((v.b.b.$ === 'VCons') && (v.b.b.b.$ === 'VCons')) && (v.b.b.b.b.$ === 'VCons')) && (v.b.b.b.b.b.$ === 'VCons')) && (v.b.b.b.b.b.b.$ === 'VNil')) {
								...
								var ry = _v29.a;
								var _v30 = _v29.b;
								return '<ellipse ' + ($author$project$Printer$Value$printFill(color) + (' cx=\"' + ($author$project$Printer$Value$print(x) + ('\" cy=\"' + ($author$project$Printer$Value$print(y) + ('\" rx=\"' + ($author$project$Printer$Value$print(rx) + ('\" ry=\"' + ($author$project$Printer$Value$print(ry) + '\"></ellipse>')))))))));
							} else {
								break _v8$18;
							}
						case 'line':
							if (((((v.b.b.$ === 'VCons') && (v.b.b.b.$ === 'VCons')) && (v.b.b.b.b.$ === 'VCons')) && (v.b.b.b.b.b.$ === 'VCons')) && (v.b.b.b.b.b.b.$ === 'VNil')) {
								...
								var y2 = _v35.a;
								var _v36 = _v35.b;
								return '<line ' + ($author$project$Printer$Value$printStroke(color) + (' x1=\"' + ($author$project$Printer$Value$print(x1) + ('\" y1=\"' + ($author$project$Printer$Value$print(y1) + ('\" x2=\"' + ($author$project$Printer$Value$print(x2) + ('\" y2=\"' + ($author$project$Printer$Value$print(y2) + '\" stroke-width=\"3\"></line>')))))))));
							} else {
								break _v8$18;
							}
						case 'polygon':
							...
							var color = _v37.a;
							var points = _v37.b;
							return '<polygon ' + ($author$project$Printer$Value$printFill(color) + (' points=\"' + ($author$project$Printer$Value$printPoints(points) + '\"></polygon>')));
						default:
							break _v8$18;
					}
				} else {
	...
	var _v38 = A2($elm$core$Debug$log, 'Value', v);
	return 'Error 50';
};
var $author$project$Printer$Value$printDBranch = function (b) {
	if (b.$ === 'DBSin') {
		var p = b.a;
		var d = b.b;
		...
		var b1 = b.a;
		var b2 = b.b;
		return $author$project$Printer$Value$printDBranch(b1) + ('|' + $author$project$Printer$Value$printDBranch(b2));
	}
};
var $author$project$Printer$Value$printDelta = function (delta) {
	switch (delta.$) {
		...
		case 'DTuple3':
			...
			var d2 = delta.b;
			var d3 = delta.c;
			return '(' + ($author$project$Printer$Value$printDelta(d1) + (', ' + ($author$project$Printer$Value$printDelta(d2) + (', ' + ($author$project$Printer$Value$printDelta(d3) + ') ')))));
		case 'DCase':
			var p = delta.a;
			var bs = delta.b;
			return 'case ' + ($author$project$Printer$Value$printParam(p) + (' of ' + $author$project$Printer$Value$printDBranch(bs)));
		case 'DFun':
			var p = delta.a;
			var d = delta.b;
			return '\\' + ($author$project$Printer$Pattern$printPattern(p) + ('->' + $author$project$Printer$Value$printDelta(d)));
...
var $author$project$Printer$Value$printEnv = function (env) {
	return '{ ' + ($author$project$Printer$Value$printEnv_(env) + '}');
};
...
var $author$project$Printer$Graphics$printGraphics = function (value) {
	switch (value.$) {
		case 'VCons':
			var v1 = value.a;
			var v2 = value.b;
			switch (v1.$) {
				case 'VCons':
					return '<g>' + ($author$project$Printer$Graphics$printGraphics(v1) + ('</g>' + $author$project$Printer$Graphics$printGraphics(v2)));
				case 'VNil':
					return '' + $author$project$Printer$Graphics$printGraphics(v2);
				default:
					return _Utils_ap(
						$author$project$Printer$Value$print(v1),
						$author$project$Printer$Graphics$printGraphics(v2));
			}
		case 'VNil':
			return '';
		default:
				...
				if (_v1.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						...
						$author$project$Main$genCanvas(
							$author$project$Printer$Graphics$printGraphics(v)));
				} else {
					var info = _v1.a;
					var _v2 = A2(
						$elm$core$Debug$log,
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$id('edit-bar')
							]),
						_List_Nil),
						A2(
						$elm$svg$Svg$svg,
